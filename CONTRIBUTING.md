...
| schema / Skill 何时升版、发版对照 | [`version/explain.md`](./version/explain.md)、[`version/releases.json`](./version/releases.json) |
| 用户怎么用 | [`README.md`](./README.md) |
| 发了哪些版（用户可见变更） | [`CHANGELOG.md`](./CHANGELOG.md) |
...
| Marketplace 发版成功后（维护者） | `version/releases.json` 追加一行 + `CHANGELOG.md` |
| 仅重构 / 排错 | `developer-record.md` 一行即可 |
| 认领并完成公开待办 | 从 `developer-mission-list.md` **删除**该条 |

三种版本线不要混用：`package.json`（Marketplace）≠ `CONFIG_VERSION`（配置 schema）≠ `AI_GUIDE_VERSION`（Skill）。三者对照见 [`version/releases.json`](./version/releases.json)；细节见 [`version/explain.md`](./version/explain.md)。
